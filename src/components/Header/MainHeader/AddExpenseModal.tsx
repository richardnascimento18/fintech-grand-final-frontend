...
export function AddExpenseModal({ userId, onClose, onAdded }: { userId: string, onClose: () => void, onAdded: () => void }) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-10 flex flex-col gap-6 w-[400px]">
                <h2 className="text-2xl font-semibold text-center">Adicionar Gasto</h2>
