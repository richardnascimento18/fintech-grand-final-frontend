...
// Utils
import { loginSchema, LoginFormFields } from "@/utils/interfaces/FormSchemas";
...
export default function LoginPage() {
    ...
    const onSubmit: SubmitHandler<LoginFormFields> = async (data) => {
        try {
            ...
            setError("root", {
                message: error instanceof Error ? error.message : "Erro desconhecido ao tentar fazer login.",
            });
        }
    };

    const isDisabled = isSubmitting || errors.email || errors.password ? true : false;
